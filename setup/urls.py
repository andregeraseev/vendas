...
from pedidos.views import pedido,pedidos,tirar_item,adicionar_item,mudar_status,imprimir,todos_pedidos,escolher_endereco,desconto
...
urlpatterns = [
    ...
    path('pedido/<slug:cliente>/<int:pedido>/escolher_endereco', escolher_endereco, name='escolher_endereco'),
    path('pedido/<slug:cliente>/<int:pedido>/desconto', desconto, name='desconto'),
